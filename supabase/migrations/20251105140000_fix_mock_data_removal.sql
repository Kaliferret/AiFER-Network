-- ============================================
-- Migration: Fix Mock Data Removal & Column Names
-- Description: Fix column name errors and remove mock data properly with correct schema
-- Dependencies: Existing AiFER network schema
-- ============================================

...
class OfflineFirstDatabase {
  ...
  Timer? _syncTimer;
  StreamController<DatabaseEvent>? _eventController;
  ...
  Future<String> _submitBlockchainTransaction(Map<String, dynamic> transaction) async {
    ...
    return 'tx_${DateTime.now().millisecondsSinceEpoch}_${Random().nextInt(10000)}';
  }
  ...
  void _setupEventStream() {
    _eventController = StreamController<DatabaseEvent>.broadcast();
  }
